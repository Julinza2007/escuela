#include <stdio.h>
int cliente, num_cuo;
float prec_boleto, monto_total, monto_cuo, descuento;
main(){
	...
	scanf("%f", & prec_boleto);
	printf("Por favor elija la cantidad de cuotas para hacer el pago (hasta 3 cuotas con intereses del 10 porciento), \n y (hasta 6 cuotas inclusive con intereses del 20 porciento) \n");
	scanf("%f", & num_cuo);
